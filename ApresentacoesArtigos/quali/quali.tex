...
\subsection{Formatação de dados ligadaos a partir de dados relacionais}
...
\subsection{Ontologias e dados publicados}
 Uma ontologia, que já estava rascunhada em instâncias
online e abertas de participação social~\cite{opsCorais} foi
...
\subsection{Aparato em software}
Fuseki, pubby, pacotes, webprotege.
