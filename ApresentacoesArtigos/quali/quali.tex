...
A ``participação direta'' (participação direta 
...
Considere que para cada tamanho $T$, sejam contadas as $\frac{R}{T}$ partes de tamanho T que cabem em R.
...
arbitrária. Uma reta descreve a relação entre $log(f)$
...
portante é razoável considerar $T_1=T_2$. 
