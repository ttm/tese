...
\begin{figure}[!h]
    ...
    \source{feita para esta monografia.}
    \label{fig:1T}
\end{figure}
\vspace{-.3cm}
...
\end{center}
\vspace{-.2cm}
\source{remixada tabela do projeto de doutorado com ocorridos e previsões atuais.}
\end{table}
\vspace{-.3cm}
...
\end{tabular}
\source{tabela feita para esta monografia.}
\end{table}
